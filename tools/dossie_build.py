...
def build_page(d, slug, lang):
    ...
    body = conteudo if conteudo else f"<p>{cfg['soon']}</p>"
...
{hreflang}
  ...
  <style>
    ...
    .dossie-page p {{ line-height: 1.7; margin: 0 0 1.2em; }}
  </style>
</head>
<body class="portfolio-page">
  <div class="dossie-page">
    <header>
      <a class="back" href="{BASE_URL}/#dossie">{cfg['back_label']}</a>
      <h1>{titulo}</h1>
